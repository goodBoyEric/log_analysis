...
def main_function(file_address=''):
    if file_address == '':
        raise ArithmeticError(u'file为空')
    ...
    for i in bytes(data):
        # print i
        data_16_i = '0x' + binascii.b2a_hex(i)
        if len(data_16_i) == 3:
...
def gsm_status(gsm_status_16):
    ...
    if gsm_status_10 == '0':
        gsm_status_data = u'gsm_status=0,模块断电'
    elif gsm_status_10 == '1':
        gsm_status_data = u'gsm_status=1,模块上电'
    elif gsm_status_10 == '2':
        gsm_status_data = u'gsm_status=2,检查模块供电PIN状态'
    elif gsm_status_10 == '3':
        gsm_status_data = u'gsm_status=3,AT指令正常'
    elif gsm_status_10 == '4':
        gsm_status_data = u'gsm_status=4,检测SIM卡'
    elif gsm_status_10 == '5':
        gsm_status_data = u'gsm_status=5,SimCard在位'
    elif gsm_status_10 == '6':
        gsm_status_data = u'gsm_status=6,注册到网络运营商'
    elif gsm_status_10 == '7':
        gsm_status_data = u'gsm_status=7,开始TCP连接'
...
def internet_status(internet_status_16):
    ...
    if internet_status_10 == '0':
        internet_status_data = u'internet_status=0,没有注册网络'
    elif internet_status_10 == '1':
        internet_status_data = u'internet_status=1,注册到了本地网络'
    elif internet_status_10 == '2':
        internet_status_data = u'internet_status=2,找到运营商但没有注册网络'
    elif internet_status_10 == '3':
        internet_status_data = u'internet_status=3,注册被拒绝'
    elif internet_status_10 == '4':
        internet_status_data = u'internet_status=4,未知的数据'
    elif internet_status_10 == '5':
        internet_status_data = u'internet_status=5,注册在漫游'
    else:
...
def signal_strength(signal_strength_16):
    ...
    if signal_strength_data == '99':
        print u'信号强度CSQ:无信号'
    elif 0 > signal_strength_data > 32:
        print u'信号强度CSQ:信号输入有误'
    else:
        print u'信号强度CSQ:信号强度为=%s' % signal_strength_data
...
def gps_status(gps_status_16):
    ...
    if gps_status_10 == '0':
        gps_status_data = u'gps_status=0,休眠状态'
    elif gps_status_10 == '1':
        gps_status_data = u'gps_status=1,运行状态'
    elif gps_status_10 == '2':
        gps_status_data = u'gps_status=2,模块开启'
    elif gps_status_10 == '3':
        gps_status_data = u'gps_status=3,模块关闭'
    elif gps_status_10 == '4':
        gps_status_data = u'gps_status=4,模块重启'
    else:
        gps_status_data = u'gps_status_data 状态错误'
        assert ArithmeticError(u'gps_status_data 状态错误')
    print(u'GPS：%s' % gps_status_data)
